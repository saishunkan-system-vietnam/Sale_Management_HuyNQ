...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th7 18, 2019 lúc 12:32 PM
...
INSERT INTO `images` (`id`, `name`, `product_id`, `status`) VALUES
(64, '2_774552.jpg', 42, NULL),
(65, '10035017-IPHONE-X_509428.jpg', 42, NULL),
(66, 'vivo_790413.jpg', 43, NULL),
(67, 'bb_542822.jpg', 43, NULL),
(68, '10035017-IPHONE-X_680180.jpg', 42, NULL);
...
(42, 1, 'Samsung Galaxy A70', 2000000, 30, '<p>abc</p>\r\n', 1, '2019-07-18 08:04:55', '2019-07-18 08:04:55', 36),
(43, 1, 'Iphone XS Max', 20000000, 24, '<p>Good</p>\r\n', 1, '2019-07-18 08:15:44', '2019-07-18 08:15:44', 4),
(44, 1, 'abc', 444, 334, '<p>aa</p>\r\n', NULL, '2019-07-18 10:02:53', '2019-07-18 10:02:53', NULL);
...
ALTER TABLE `cart_details`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_cartDetail_cart` (`cart_id`);
...
--
ALTER TABLE `carts`
  ADD CONSTRAINT `fk_cart_user` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`) ON DELETE NO ACTION ON UPDATE CASCADE;

--
-- Các ràng buộc cho bảng `cart_details`
--
ALTER TABLE `cart_details`
  ADD CONSTRAINT `fk_cartDetail_cart` FOREIGN KEY (`cart_id`) REFERENCES `carts` (`id`) ON DELETE NO ACTION ON UPDATE CASCADE;

--
-- Các ràng buộc cho bảng `images`
--
ALTER TABLE `images`
  ADD CONSTRAINT `fk_image_product` FOREIGN KEY (`product_id`) REFERENCES `products` (`id`) ON DELETE NO ACTION ON UPDATE CASCADE;

--
-- Các ràng buộc cho bảng `orders`
--
ALTER TABLE `orders`
  ADD CONSTRAINT `fk_order_user` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`) ON DELETE NO ACTION ON UPDATE CASCADE;

--
-- Các ràng buộc cho bảng `order_details`
--
ALTER TABLE `order_details`
  ADD CONSTRAINT `fk_orderDetail_order` FOREIGN KEY (`order_id`) REFERENCES `orders` (`id`) ON DELETE NO ACTION ON UPDATE CASCADE;

--
-- Các ràng buộc cho bảng `products`
--
ALTER TABLE `products`
  ADD CONSTRAINT `fk_product_category` FOREIGN KEY (`category_id`) REFERENCES `categories` (`id`) ON DELETE NO ACTION ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_product_user` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`) ON DELETE NO ACTION ON UPDATE CASCADE;
...
('root', '[{\"db\":\"internship\",\"table\":\"images\"},{\"db\":\"internship\",\"table\":\"order_details\"},{\"db\":\"internship\",\"table\":\"orders\"},{\"db\":\"internship\",\"table\":\"products\"},{\"db\":\"internship\",\"table\":\"product_images\"},{\"db\":\"internship\",\"table\":\"carts\"},{\"db\":\"internship\",\"table\":\"product_categories\"},{\"db\":\"internship\",\"table\":\"cart_details\"},{\"db\":\"internship\",\"table\":\"attributes\"},{\"db\":\"internship\",\"table\":\"product_attributes\"}]');
...
('internship', 'cart_details', 'name'),
('internship', 'images', 'name'),
('internship', 'order_details', 'name'),
('internship', 'orders', 'name'),
('internship', 'product_attributes', 'value'),
('internship', 'products', 'name');
...
('root', '2019-07-18 10:32:29', '{\"Console\\/Mode\":\"collapse\",\"lang\":\"vi\"}');
