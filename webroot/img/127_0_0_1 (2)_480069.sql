...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th7 14, 2019 lúc 09:02 PM
...
--
CREATE DATABASE IF NOT EXISTS `internship` DEFAULT CHARACTER SET utf8 COLLATE utf8_vietnamese_ci;
USE `internship`;
...
INSERT INTO `attributes` (`id`, `name`, `parent_id`) VALUES
(1, 'screen', 0),
(2, '6 inch', 1),
(3, '11 inch', 1),
(4, '12 inch', 1),
...
(26, '2MP', 20),
(27, '100', 19),
(28, 'Qualcomm Snapdragon 450 8 nhân 64-bit', 18),
(29, '3000', 17),
(30, '4000', 10),
(31, '4500', 10),
(33, '15 inch', 1),
...
INSERT INTO `images` (`id`, `name`) VALUES
(43, 'iphone-x-image_318346.png'),
(45, 'de1d3e9c9062428b170bd739102621eb_570_570_348617.png');
...
CREATE TABLE `order_details` (
  ...
  `name` varchar(100) COLLATE utf8_vietnamese_ci DEFAULT NULL,
  `price` int(11) DEFAULT NULL,
  `quantity` varchar(100) COLLATE utf8_vietnamese_ci DEFAULT NULL,
  `created` datetime DEFAULT NULL,
  `modified` datetime DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_vietnamese_ci;
...
INSERT INTO `products` (`id`, `user_id`, `name`, `price`, `quantity`, `description`, `status`, `created`, `modified`, `category_id`) VALUES
(3, 1, 'SamSung Glaxy S8', 4000000, 23, 'Good', NULL, '2019-07-13 00:00:00', '2019-07-14 00:00:00', NULL),
(5, 1, 'Iphone X', 8000000, 25, 'Good', NULL, '2019-07-14 00:00:00', '2019-07-14 00:00:00', NULL);
...
INSERT INTO `product_images` (`id`, `image_id`, `product_id`, `status`) VALUES
(35, 43, 5, NULL),
(37, 45, 5, NULL);
...
CREATE TABLE `users` (
  ...
  `notice` varchar(100) COLLATE utf8_vietnamese_ci DEFAULT NULL,
  `created` datetime DEFAULT NULL,
  `modified` datetime DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_vietnamese_ci;
...
INSERT INTO `users` (`id`, `email`, `username`, `password`, `name`, `phone`, `address`, `type`, `notice`, `created`, `modified`) VALUES
(1, 'admin@gmail.com', 'admin', '123456', 'huy', 1231, 'Hà Nội', 1, 'admin', NULL, NULL);
...
ALTER TABLE `product_attributes`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_productAttribues_Attribues` (`attribute_id`),
  ADD KEY `fk_productAttribues_Products` (`product_id`);
...
--
ALTER TABLE `product_attributes`
  ADD CONSTRAINT `fk_productAttribues_Attribues` FOREIGN KEY (`attribute_id`) REFERENCES `attributes` (`id`) ON DELETE NO ACTION ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_productAttribues_Products` FOREIGN KEY (`product_id`) REFERENCES `products` (`id`) ON DELETE NO ACTION ON UPDATE CASCADE;
--
-- Cơ sở dữ liệu: `my_app`
--
CREATE DATABASE IF NOT EXISTS `my_app` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_vietnamese_ci;
USE `my_app`;
...
(1, 1, 'First Post 1', 'first-post', 'This is the first post.', 1, '2019-07-02 14:50:26', '2019-07-04 02:28:32'),
(5, 1, 'Fourth Post', 'Fourth-Post', 'Fourth Post 1', 1, '2019-07-03 06:48:58', '2019-07-03 06:48:58'),
(15, 1, 'Fifth Post', 'Fifth-Post', 'Fifth Post', 1, '2019-07-03 09:38:42', '2019-07-03 09:38:42');
...
(2, 'First Tag', '2019-07-03 06:10:44', '2019-07-03 06:10:44'),
(3, 'Second Tag', '2019-07-03 06:13:27', '2019-07-03 06:13:27'),
(4, 'Third Tag', '2019-07-03 06:27:28', '2019-07-03 06:27:28');
...
(1, 'cakephp@example.com', '$2y$10$Ok3j57x0bZDueHbnHTVyO.jTHdTDGQvuiFPrh5Fe7CTSfI8c7Q2Eu', '2019-07-02 14:50:26', '2019-07-03 07:13:30'),
(2, 'huynq3697@gmail.com', '$2y$10$hZpEjFJeH2kHglK7FbdQBuyGKaXdYeD/CCFtyOlGGj58RpJ8qCOTq', '2019-07-03 07:13:50', '2019-07-03 07:13:50'),
(3, 'huynq@gmail.com', '$2y$10$xtG09BGtJYOJVVkfXAM4D.IyTYs3I76d3TNjIjiXeXeNtiBZiGAlq', '2019-07-03 07:45:08', '2019-07-03 07:45:08'),
(4, 'huy@gmail.com', '$2y$10$qQTJKv/prh7mBBJSuuS0nOHWfSAhrieuutUetOxug4xgN4Yo2ycf2', '2019-07-04 08:01:45', '2019-07-04 08:01:45');
...
('root', '[{\"db\":\"internship\",\"table\":\"product_attributes\"},{\"db\":\"internship\",\"table\":\"attributes\"}]');
...
('root', '2019-07-14 19:02:26', '{\"Console\\/Mode\":\"collapse\",\"lang\":\"vi\"}');
...
USE `test`;
--
-- Cơ sở dữ liệu: `traning`
--
CREATE DATABASE IF NOT EXISTS `traning` DEFAULT CHARACTER SET utf8 COLLATE utf8_vietnamese_ci;
USE `traning`;
...
CREATE TABLE `products` (
  ...
  `body` text COLLATE utf8_vietnamese_ci DEFAULT NULL,
  `created` datetime DEFAULT NULL,
  `modified` datetime DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_vietnamese_ci;
...
INSERT INTO `products` (`id`, `user_id`, `name`, `price`, `quantity`, `image`, `body`, `created`, `modified`) VALUES
(1, 1, 'First Product', 1000000, 10, NULL, 'This is the first product.', '2019-07-06 17:54:59', '2019-07-06 17:54:59'),
(4, 1, 'SamSung Glaxy S8', 2000000, 20, NULL, 'This is Mobile', '2019-07-06 18:19:12', '2019-07-06 18:19:12'),
(5, 1, 'Oppo', 1000000, 5, NULL, 'abc', '2019-07-07 01:51:42', '2019-07-07 01:51:42');
...
INSERT INTO `users` (`id`, `email`, `password`, `created`, `modified`) VALUES
(1, 'cakephp@example.com', '123456', '2019-07-06 17:54:59', '2019-07-07 23:10:33'),
(2, 'huynq@gmail.com', '123456', '2019-07-07 00:53:04', '2019-07-07 22:44:28'),
(3, 'huynq3697@gmail.com', '123456', '2019-07-07 22:36:19', '2019-07-07 22:44:33');
