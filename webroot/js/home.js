...
$(document).ready(function(){
   ...
   for (var i = 0; i < time.length; i++) {
        var time2 =$(".time").eq(i).attr("endday");
        // console.log(time2);
        countdown(time2, $(".time").eq(i));
   }
})
...
function countdown(time, el) {
    ...
    var x = setInterval(function() {
      ...
      el.html("<li><span>" + days + " D</span></li> <li><span>" + hours + " H</span></li> <li><span> "+ minutes + " M</span></li> <li><span> " + seconds + " S</span></li>");
    }, 1000);
}